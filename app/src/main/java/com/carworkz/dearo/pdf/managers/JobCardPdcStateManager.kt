...
@Parcelize
class JobCardPdcStateManager(val jobCardId: String, val displayId: String) : StateManager(), Parcelable {
    ...
    override fun start() {
        ...
        // TODO: 28/7/21 Change API For PDC Print
        repository.getPrintJobCardPdc(jobCardId, object : DataSource.OnResponseCallback<PDF> {
