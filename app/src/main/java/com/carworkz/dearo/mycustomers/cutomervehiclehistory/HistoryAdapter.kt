...
class HistoryAdapter(val list: List<History>, val registrationNumber: String, val interaction: MyCustomerVehicleInteraction) : RecyclerView.Adapter<HistoryAdapter.ViewHolder>()
{
